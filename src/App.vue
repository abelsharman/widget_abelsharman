<template>
  <div id="app" class="widget" @click="clickWidget">
    <v-app class="app_1" v-if="width > 768" style="background: #e7ecef !important ; border-radius: 10px !important ; padding: 5vw 10% !important ; width: 80% !important ;height: 40vh !important ; overflow-y: scroll !important ; display: inline-block !important ; box-sizing: content-box;" :style="[ resultCheck || checkForm ? { 'height': '80vh', 'background-color': background }: { 'height': '40vh', 'background-color': background }]">
      ...
      <div class="text-center" v-show="width > 768" style="margin-top: 13vh !important ; position: relative !important ; transition: 0.5s all ease !important ;left: 94% !important ; width: 10vw !important ;" :style="[ resultCheck || checkForm && width > 768 ? { 'marginTop': '0vh', 'top': '-50px', 'left': '88% !important' }: { 'marginTop': '13vh', 'top': '0px', 'left': '42% !important'  }]">
        <v-btn
    ...
    <v-app class="app_1" v-if="width <= 768" style="transition: all 0.5s ease !important ;background: #e7ecef !important ; border-radius: 10px !important ; padding: 5vw 10% !important ; width: 100% !important ;height: 40vh !important ; overflow-y: scroll !important ; display: inline-block !important ;" :style="[ resultCheck || checkForm ? { 'height': '90vh', 'padding': '5vw 2%', 'background-color': background }: { 'height': '40vh', 'padding': '5vw 10%', 'background-color': background }]">
      ...
      <div class="text-center" style="margin-top: 13vh !important ; position: relative !important ; transition: 0.5s all ease !important ;left: 94% !important ; width: 10vw !important ;" :style="[ resultCheck || checkForm ? { 'marginTop': '0vh', 'top': '-39px', 'left': '75% !important' }: { 'marginTop': '13vh', 'top': '0px', 'left': '35% !important'  }]">
        <v-btn
          class="widget_button_primary_color"
